...
description: >-
  Describes building, testing, and contributing to the Electron framework
  upstream repo (GN/Ninja, `e` CLI, patches, Chromium, PR conventions). Use
  when working inside electron/electron, running `e sync`/`e build`, patch
  workflows, or when the user mentions Electron core development—not for
  typical Electron desktop apps unless they reference this toolchain.
---

# Electron Development Guide

This file is a copy of [Electron’s `CLAUDE.md`](https://github.com/electron/electron/blob/main/CLAUDE.md) on `main` (upstream framework development). To refresh from source: `curl -fsSL https://raw.githubusercontent.com/electron/electron/main/CLAUDE.md`.
